...
class OpenIDConnectClient
{
	...
	protected function requestAuthorization() {
		...
		$auth_endpoint_callback = $this->providerConfig["auth_endpoint_callback"];
		if ($auth_endpoint_callback && is_callable($auth_endpoint_callback))
			$auth_endpoint .= call_user_func($auth_endpoint_callback, '?' . http_build_query($auth_params, null, '&'));
        else
